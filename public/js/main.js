...
const getInfo = async(event) =>{
    ...
    if(cityVal == ""){
       ...
       try{
        let url = `http://api.openweathermap.org/data/2.5/weather?q=${cityVal}&units=metric&appid=cd76f2f65d383a1b164dbbdd5be227b9`
        ...
        temp_real_val.innerText = arrData[0].main.temp;
         ...
         // condition weather to be sunny or cloudy
         if(tempMood == "clear"){
